...
import { Mail, Lock, Eye, EyeClosed, ArrowRight, Sparkles } from 'lucide-react';
...
function Input({ className, type, ...props }: React.ComponentProps<'input'>) {
  return (
    <input
      ...
      data-slot="input"
      className={cn(
        'placeholder:text-white/30 flex h-9 w-full min-w-0 rounded-md border bg-transparent px-3 py-1 text-base shadow-xs transition-[color,box-shadow] outline-none disabled:pointer-events-none disabled:cursor-not-allowed disabled:opacity-50 md:text-sm',
...
export function SignInCard() {
  ...
  return (
    <div className="min-h-screen w-full bg-slate-950 relative overflow-hidden flex items-center justify-center">
      {/* Background gradient effect — EchoLearn indigo palette */}
      <div className="absolute inset-0 bg-gradient-to-b from-indigo-500/30 via-indigo-800/40 to-slate-950" />
      ...
      {/* Top radial glow */}
      <div className="absolute top-0 left-1/2 transform -translate-x-1/2 w-[120vh] h-[60vh] rounded-b-[50%] bg-indigo-400/15 blur-[80px]" />
      <motion.div
        className="absolute top-0 left-1/2 transform -translate-x-1/2 w-[100vh] h-[60vh] rounded-b-full bg-indigo-300/15 blur-[60px]"
        animate={{
      ...
      />
      <motion.div
        className="absolute bottom-0 left-1/2 transform -translate-x-1/2 w-[90vh] h-[90vh] rounded-t-full bg-cyan-400/10 blur-[60px]"
        animate={{
          ...
          <div className="relative group">
            ...
            <div className="absolute -inset-[1px] rounded-2xl overflow-hidden">
              ...
              <motion.div
                ...
                transition={{
                  left: { duration: 2.5, repeat: Infinity, repeatDelay: 1 },
              ...
              <motion.div
                ...
                transition={{
                  top: { duration: 2.5, repeat: Infinity, repeatDelay: 1, delay: 0.6 },
              ...
              <motion.div
                ...
                transition={{
                  right: { duration: 2.5, repeat: Infinity, repeatDelay: 1, delay: 1.2 },
              ...
              <motion.div
                ...
                transition={{
                  bottom: { duration: 2.5, repeat: Infinity, repeatDelay: 1, delay: 1.8 },
            ...
            <div className="relative bg-black/40 backdrop-blur-xl rounded-2xl p-6 border border-white/[0.05] shadow-2xl overflow-hidden">
              ...
              <div className="text-center space-y-1 mb-5">
                ...
                >
                  Sign in to continue to EchoLearn
                </motion.p>
              </div>
              ...
              >
                ...
                >
                  ...
                  <div className="relative overflow-hidden bg-white/5 text-white font-medium h-10 rounded-lg border border-white/10 hover:border-white/20 transition-all duration-300 flex items-center justify-center gap-2">
                    <div className="w-4 h-4 flex items-center justify-center text-white/80 group-hover/google:text-white transition-colors duration-300 font-semibold text-xs">
                      G
                    </div>
                ...
                >
                  ...
                  <Link to="/dashboard" className="relative inline-block group/signup">
